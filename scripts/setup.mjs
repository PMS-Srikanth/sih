...
console.log(`\n${B}  Built and verified. Now start it:${X}\n`);
console.log(`      ${B}npm start${X}`);
console.log(`      ${D}runs the agent server and the demo pages, and prints the URLs.${X}`);
console.log(`      ${D}Leave that terminal open.${X}\n`);
console.log(`${B}  Two things it cannot do for you:${X}\n`);
console.log(`  ${B}1 · Load the extension${X} — chrome://extensions → Developer mode →`);
...
console.log(`  ${B}2 · Create your vault${X} — open the side panel, expand ${B}My data${X}, choose a`);
